...
const rating = ({ rating, showLabel, color = 'warning', size = 'md', icon = 'star', ...props }: RatingProps) => {
  return (
    <Flex as="figure" gap="sm" items="center" className={`rating rating__${size} u_${color}`} {...props}>
      ...
      <figcaption {...classnames('u_font-medium', { 'u_sr-only': !showLabel })}>
