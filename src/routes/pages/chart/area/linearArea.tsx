import { ResponsiveContainer, XAxis, CartesianGrid, AreaChart, Area, Tooltip } from 'recharts'
...
export const LinearArea = () => {
  return (
    <ChartLayout title="Linear area chart">
      <ResponsiveContainer width="100%" height={300}>
        ...
        >
          ...
          />
          <Tooltip />
          <Area dataKey="desktop" type="linear" fill="var(--Se6)" fillOpacity={0.6} stroke="var(--Se9)" />
        </AreaChart>
      </ResponsiveContainer>
    </ChartLayout>
  )
