import { PolarGrid, RadialBar, RadialBarChart, ResponsiveContainer, Tooltip } from 'recharts'
...
export const RadialGrid = () => {
  return (
    <ChartLayout title="Radial with Label">
      <ResponsiveContainer width="100%" height={300}>
        <RadialBarChart data={data} innerRadius={30} outerRadius={110}>
          <Tooltip cursor={false} />
          <PolarGrid gridType="circle" stroke="var(--B5)" />
          <RadialBar dataKey="visitors" background={{ fill: 'transparent' }} />
        </RadialBarChart>
      </ResponsiveContainer>
    </ChartLayout>
  )
